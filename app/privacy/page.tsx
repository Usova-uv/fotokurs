      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-zinc-300">
              На Сайте используются сервисы аналитики (Яндекс.Метрика, Vercel Analytics) для оценки посещаемости и улучшения работы. Эти сервисы могут сохранять cookies и собирать обезличенные данные о посещениях. Вы можете отключить cookies в настройках браузера.
            </p>
          </section>
